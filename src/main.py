...
IMG_XY = 28
IMG_SIZE = IMG_XY * IMG_XY


def nn_optimizer(train_images, train_labels):
	...
	grid_params = {
				...
				'learning_rate'      : ['constant', 'variable'],
...
def main():
	...
	if False:
		...
		#for v in train_images2[:784]:
			#print(v)
		mlp = train_model(train_images2, train_labels, test_images2, test_labels)
